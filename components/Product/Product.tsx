		...
		<div className={className} {...props} ref={ref}>
			<Card className={styles.product}>
				...
				<div className={styles.price}>
					<span><span className="visuallyHidden">Цена</span>{priseRu(product.price)}</span>
					{product.oldPrice && 
						<Tag className={styles.oldPrice} 
						color='green'>
							<span className="visuallyHidden">Скидка</span>
							{priseRu(product.price - product.oldPrice)}
						</Tag>}
				</div> 
				<div className={styles.credit}>
					<span className="visuallyHidden">Кредит</span>
					{priseRu(product.credit)}/<span className={styles.mounth}>мес</span>
				</div>
				...
				<div className={styles.rateTitle}><a href='#ref' onClick={scrollToReviews}>{product.reviewCount} {declOfNum(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a></div>
